...
def main():
    ...
    title = story_en[:220] if story_en else topic[:220] if topic else "Ancient Women's History"
    hashtags = "#histoiredesfemmes #histoireancienne #éducation #fyp"
    desc_fr = story[:1000] if len(story) > 1000 else story
